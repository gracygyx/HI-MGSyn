...
from HI_MGSyn_GDSC2 import HIMGSyn, DrugGNN, CellMLP, SSI, HgnnEncoder
import glob
...
if __name__ == '__main__':
    for fold in range(0, 5):
        ...
        drug = pd.read_csv('Data/DrugComb/GDSC2_cid_unique.csv')
        ...
        gene_data = pd.read_csv('Data/DrugComb/GDSC2_cellline(z_score).csv', sep=',', header=0, index_col=[0])
        ...
        synergy_load_train = pd.read_csv(f'Data/DrugComb/GDSC2_cv5_train_fold_{fold}.csv')
        synergy_load_test = pd.read_csv(f'Data/DrugComb/GDSC2_cv5_test_fold_{fold}.csv')
